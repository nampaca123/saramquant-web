...
export const onboardingTexts = {
  ...
  errorSessionExpired: { ko: '세션이 만료되었어요. 다시 로그인해주세요.', en: 'Your session has expired. Please log in again.' } satisfies LocalizedText,
  errorSubmit: { ko: '저장 중 오류가 발생했어요. 잠시 후 다시 시도해주세요.', en: 'Something went wrong. Please try again later.' } satisfies LocalizedText,
} as const;
